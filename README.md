...
- 👨‍💻 All of my projects are available at [GitHub](https://github.com/sakthipratheesh)

- 💬 Having a Knowledge of API testing using Rest Assured, Web App testing using Katalon and Web app automation testing using Selenium .

- 📝 Knowledge of generating test reports using ** TestNG and Extent reports.**
